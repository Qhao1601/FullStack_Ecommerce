...
const loginSchema = z.object({
  email: z.string().email("Email không hợp lệ ví dụ: hao@gmail.com"),
...
export function LoginForm({
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<TLoginRequest>({
    ...
    defaultValues: {
      email: "quochao16012k3@gmail.com",
      password: "password",
    }
  });
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-3">
                ...
                />
                {errors.email && (
                  <div className="text-[12px] text-[#f00000]">{errors.email.message}</div>
                )}
              </div>
              <div className="grid gap-3">
                ...
                />
                {errors.password && (
                  <div className="text-[12px] text-[#f00000]">{errors.password.message}</div>
                )}
              </div>
