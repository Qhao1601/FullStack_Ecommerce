...
const config: IConfigModule<IBrand> = {
    endpoint: 'v1/brands',
    title: 'Quản lý thương hiệu',
    description: 'Quản lý thông tin danh sách thương hiệu',
    ...
    columns: [
        ...
        { key: 'name', label: 'Tên thương hiệu', className: 'text-left w-[25%]' },
        { key: 'user_id', label: 'Người tạo', className: 'text-left w-[100px]' },
        { key: 'createdAt', label: 'Ngày tạo', className: 'text-center w-[100px]' },
            ...
            <div className="flex flex-1 flex-col gap-4 p-4 bg-[#f3f3f4] pt-[20px]">
                <Card className="rounded-[5px]">
                    ...
                    <CardFooter className="borderr-t">
                        {!isLoading && brands && 'data' in brands && isApiSuccessResponse(brands) && 'links' in brands.data && (
                            <PaginateComponent
                                links={brands.data.links}
                                // click chuyển trang
                                onPageChange={handlePageChange}
                                from={brands.data.from}
                                to={brands.data.to}
                                total={brands.data.total}
                                currentPage={brands.data.current_page}
                            />
                        )}
                    </CardFooter>
                </Card>
