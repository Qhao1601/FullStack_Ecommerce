...
import { IBrand, IBrandRequest } from "@/interfaces/brands/brand.interface";
...
const createSchema = z.object({
    name: z.string().min(1, { message: 'Từ khóa của thương hiệu bắt buộc' }),
    // title: z.string().min(1, { message: 'Tên thương hiệu bắt buộc phải nhập' }),
    // module: z.string().min(1, { message: 'Tên module bắt buộc phải nhập' }),
    // description: z.string().optional(),
    // value: z.number().min(1, { message: 'Giá trị thương hiệu bắt buộc phải nhập' }),
})
const formConfig = {
    schema: createSchema,
    defaultValues: {
...
const BrandSave = () => {
    ...
    const { onSubmit, form, record } = useCurd<IBrand, IBrandRequest, TFromValues>(formConfig)
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="col-span-1">
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            <FormLabel>Từ khóa thương hiệu</FormLabel>
                                                            <FormControl>
                                                                <Input {...field} />
                                                            </FormControl>
                                                            <FormMessage />
                                        ...
                                        {/* <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <div className="col-span-1">
                                                <FormField
                                                    ...
                                                    render={({ field }) => (
                                                        <FormItem>
                                                            <FormLabel>Giá trị thương hiệu</FormLabel>
                                                            <FormControl>
                                                                <Input autoComplete=""  {...field}
                                                                    onChange={(e) => {
