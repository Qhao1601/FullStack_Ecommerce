...
import { IPermissionRequest, IPermission } from "@/interfaces/permissions/permission.interface";
...
const formConfig = {
    ...
    mapToRequest: (values: {
        ...
        description?: string,
        value: number,
    }, userId?: number): IPermissionRequest => ({
        ...values,
        userId
    })
}
...
const PermissionsSave = () => {
    ...
    const { onSubmit, form, record } = useCurd<IPermission, IPermissionRequest, TFromValues>(formConfig)
