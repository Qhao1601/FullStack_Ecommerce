...
const config: IConfigModule<IPostCatalogue> = {
    endpoint: '/v1/post_catalogues',
    title: 'QL nhóm bài viết',
    description: 'Quản lý thông tin danh sách nhóm bài viết',
    createLink: '/post_catalogues/create',
    ...
    <TableRow key={item.id} className="hover:bg-gray-50">
        ...
        <TableCell>
            <div className="flex items-center justify-center gap-2">
                <Link to={`/post_catalogues/edit/${item.id}`}>
